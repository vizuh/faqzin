...
class FAQzin_Manager {
    ...
    public function enqueue_assets() {
        ...
        if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'faqzin')) {
            ...
            wp_enqueue_style('faqzin-styles', FAQZIN_PLUGIN_URL . 'faq.css', array(), FAQZIN_VERSION);
            wp_enqueue_script('faqzin-accordion', FAQZIN_PLUGIN_URL . 'faq.js', array('jquery'), FAQZIN_VERSION, true);
